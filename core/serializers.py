...
#     address_line1 = serializers.CharField(source='user.address.line1')
#     address_city = serializers.CharField(source='user.address.city')
#     address_state = serializers.CharField(source='user.address.state')
#     address_pincode = serializers.CharField(source='user.address.pincode')
#     profile_picture = serializers.ImageField(source='user.profile_picture.image')

#     class Meta:
#         model = models.Patient
#         fields = ['id', 'user_id', 'username', 'first_name', 
#             'last_name', 'email', 'password', 'address_line1', 'address_city',
#             'address_state', 'address_pincode', 'profile_picture']

#     def create(self, validated_data):
#         print(validated_data)        
#         address = validated_data["user"].pop("address")
#         profile_picture = validated_data["user"].pop("profile_picture")

#         user = UserCreateSerializer.create(UserCreateSerializer(), validated_data["user"])
